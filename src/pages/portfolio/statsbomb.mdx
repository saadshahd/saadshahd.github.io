...
```
        ...
        <figure role="img" aria-labelledby="diagram-data-flow" class="my-8 bg-surface border border-neutral-light rounded-lg p-6">
...
```
          ...
          <details class="mt-4">
            <summary class="cursor-pointer text-sm text-neutral-light hover:text-accent">Text description of relationships</summary>
            <ul class="mt-2 ml-4 text-sm text-neutral space-y-1">
    ...
    <div class="mb-12">
      ...
      <div class="prose prose-lg max-w-none">
        ...
        <figure role="img" aria-labelledby="diagram-event-dependency" class="my-8 bg-surface border border-neutral-light rounded-lg p-6">
...
```
    ...
    <div class="mb-8">
      ...
      <div class="prose prose-lg max-w-none">
        ...
        <figure role="img" aria-labelledby="diagram-metadata-claims" class="my-8 bg-surface border border-neutral-light rounded-lg p-6">
