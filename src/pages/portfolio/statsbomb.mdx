...
The industry-standard tool—Dartfish—couldn't scale to what we needed. Rigid forms forced mouse clicks for every field. No keyboard shortcuts meant analysts couldn't build muscle memory. Two collectors per match, each following a team, manually entering 3000+ events over 16 hours. Duplicated effort. No prevention, only validation after mistakes happened.
...
**Metadata was different.** Players, clubs, referees, stadiums—reference data that
