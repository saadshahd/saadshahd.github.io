...
<Quote icon={true} attribution="A.Magdy, 360 Collection Lead">
  Freeze frame collection reduced from 12 minutes (manual clicking, Dartfish) to 30 seconds (CV-assisted workflow). Computer vision detected 90% automatically; collectors corrected edge cases with eyes on video, hands on keyboard.
</Quote>
