...
<div class="grid md:grid-cols-3 gap-6 mb-8">
  ...
  <div class="text-center leading-relaxed rotate-90 md:rotate-0"><span class="text-text-lighter/80 mr-2">became</span><MoveRight class="w-5 h-5 text-neutral inline"/></div>

  <div calss="text-center md:text-right">
    `carry, flight, loose`
  </div>
</div>
