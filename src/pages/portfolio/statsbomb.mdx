...
<div class="grid md:grid-cols-2 gap-6 mb-8">
  <ComparisonCard variant="before" title="Engineering Bottleneck">
    <ul class="space-y-3">
      <li><strong>American football expansion:</strong> 12-month engineering estimate blocked product roadmap expansion</li>
      <li><strong>Dataspec changes:</strong> 5-day engineering cycle (code → test → deploy → regression) per rule change</li>
      <li><strong>Support burden:</strong> 2 product managers fielded 50+ daily Slack questions about dataspec interpretation</li>
    </ul>
  </ComparisonCard>
