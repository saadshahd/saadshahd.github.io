...
<div class="max-w-4xl mx-auto px-4 md:px-6 py-20">
  <div class="mb-8">
    ...
    <p class="text-sm text-text-lighter font-medium uppercase tracking-wide mb-1">Technical Deep Dive</p>
    <h1 class="text-base md:text-lg text-navy font-medium mb-2">Statsbomb Architecture: Implementation Details</h1>
    <Body size="base" as="p" class="text-text-lighter mb-6">Code examples, state machine configurations, functional pipeline patterns, and technical specifications from the real-time sports data collection system.</Body>
  </div>

  <Callout variant="secondary" icon="info" size="default" title="Prerequisites">
    <p>This appendix assumes you've read the <a href="/portfolio/statsbomb" class="text-secondary hover:text-secondary-dark underline">main case study</a>. It provides implementation details for engineers interested in DSL design, state machine architecture, and functional data pipelines.</p>
  </Callout>

  {/* Table of Contents */}
  <nav class="my-12 p-6 bg-surface rounded-lg border border-neutral-light" aria-label="Table of contents">
    <h2 class="text-sm uppercase tracking-wide text-text-lighter font-semibold mb-4">Contents</h2>
    <ul class="space-y-2 text-sm">
      <li><a href="#dsl-implementation" class="text-text-lighter hover:text-secondary transition-colors">DSL Implementation</a></li>
      <li><a href="#state-machines" class="text-text-lighter hover:text-secondary transition-colors">State Machine Architecture</a></li>
      <li><a href="#functional-pipelines" class="text-text-lighter hover:text-secondary transition-colors">Functional Data Pipelines</a></li>
      <li><a href="#event-graphs" class="text-text-lighter hover:text-secondary transition-colors">Event Dependency Graphs</a></li>
      <li><a href="#metadata-claims" class="text-text-lighter hover:text-secondary transition-colors">Claims-Based Metadata</a></li>
      <li><a href="#keyboard-mappings" class="text-text-lighter hover:text-secondary transition-colors">Keyboard Shortcut System</a></li>
      <li><a href="#computer-vision" class="text-text-lighter hover:text-secondary transition-colors">Computer Vision Integration</a></li>
    </ul>
  </nav>
  ...
  <section class="mb-16" id="dsl-implementation">
    ...
    <Body size="base" as="p" class="mb-6 text-text-lighter leading-relaxed">
    ...
    <Callout variant="success" icon="code" size="default" title="System 1 of 3: Domain Logic as Configuration">
...
- **Trade-off**: ANTLR added build complexity (Java dependency), but paid off when expanding to American football
    ...
    <Callout variant="primary" icon="lightbulb" size="compact" title="Why this order matters">
...
- **Incremental evaluation**: Only evaluate rules against new events, not entire stream (performance optimization added year two)
  ...
  <section class="mb-16" id="state-machines">
    ...
    <Callout variant="success" icon="code" size="compact" title="System 2 of 3: State Machines as UI Controller">
...
Collectors pressed `/` to toggle loop mode—video replayed 5-second window while they filled fields. No manual rewinding. Hands stayed on keyboard. Eyes stayed on video.
  ...
  <section class="mb-16" id="functional-pipelines">
    ...
    <Callout variant="success" icon="code" size="compact" title="System 3 of 3: Functional Pipelines for Data Transformation">
...
- **Debugging**: Visualize event chains to understand data quality issues
  ...
  <section class="mb-16" id="metadata-claims">
    ...
    <Callout variant="primary" icon="lightbulb" size="compact" title="Architectural Leverage">
...
- **Discoverability**: UI shows available shortcuts for current context
  ...
  <section class="mb-16" id="computer-vision">
    ...
    <Callout variant="warning" icon="alert" size="compact" title="Trade-off: Full Automation vs. Quality">
