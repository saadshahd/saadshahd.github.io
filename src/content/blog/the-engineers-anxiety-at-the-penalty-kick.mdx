  ...
  beats={[
    {
      ...
      alt: "Penalty 1, full-stretch near-save",
      label: "Penalty 1 — Minute 01",
      labelColor: "#F4C430",
      paras: [
    ...
    {
      src: "/images/blog/the-engineers-anxiety-at-the-penalty-kick/pen-04.webp",
      alt: "Penalty 4, the save",
      label: "Penalty 4 — Minute 04",
      labelColor: "#F4C430",
      paras: [
    ...
    },
    {
      ...
      alt: "Penalty 48, standing motionless",
      label: "Penalty 48 — Minute 48",
      labelColor: "#475569",
      paras: [
    ...
    },
    {
      ...
      alt: "Penalty 73, smoking outside the goal",
      label: "Penalty 73 — Minute 73",
      labelColor: "#94A3B8",
      paras: [
    ...
    },
    {
      ...
      alt: "Penalty 89, asleep in bed",
      label: "Penalty 89 — Minute 89",
      labelColor: "#DDD6C6",
      paras: [
